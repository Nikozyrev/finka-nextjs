...
export const Sidebar = ({ contentTop, contentBottom }: ISidebarProps) => {
  ...
  return (
    <div className="border-b-2 border-b-slate-400 p-2 sm:p-0">
      <button
      ...
      >
        <div className="h-full px-4 py-4 flex flex-col justify-between overflow-y-auto bg-white dark:bg-gray-800">
